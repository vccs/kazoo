...
%% arity 2 of `(JObj, Acc)'.
%%
%% The result set is already reversed by {@link last_key/4} for finding
%% the last key when so data that is passed to mapper/filter function is already
%% reversed.
%%
%% If mapper is a function of arity 1, the end result has to be the in reverse
%% order of input, for example you can use {@link lists:foldl/3} to do the
...
%% as input, in other words, DO NOT change the order!
%%
